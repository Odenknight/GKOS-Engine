...
export function shouldRetryWatcherQualification(result, output, artifactCount, attempt) {
  return attempt === 0 && result.status === 1 && result.signal === null && artifactCount === 0
    && output.includes("GKX_WATCHER_QUALIFICATION_LATENCY_EXCEEDED");
}
