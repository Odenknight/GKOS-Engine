...
Build and 23 focused tests passed on Windows Node24.18.0: scanner/validation,
...
A separate width8/16 experiment was faster but was not adopted because this
...
The uninstrumented activation smoke at4b2c587 took15,121ms and still failed the
unchanged2,000ms budget. Receipt: watcher-scan-scheduling-smoke/receipt.json.
No end-to-end qualification or24-hour pass is claimed.

Separately, main0a1dbfc CI run34749573881 failed the WindowsNode26 watcher
