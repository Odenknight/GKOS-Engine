...
| G5 broker | Private broker/HTTP bounds pass; read-only driver and fresh published-ledger query boundary pass 34 host tests, thirteen live synthetic checks and four Python/TypeScript wire checks | Complete product-host scope authorization, authenticated product endpoint and outage integration |
