...
| G5 broker | Private broker/HTTP bounds and cancellation checks pass; exact SDK read-only driver passed seven live database checks | Actual semantic query and fresh ledger/citation wiring, authenticated product endpoint and outage integration |
