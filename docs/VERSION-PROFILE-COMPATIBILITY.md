...
| --- | --- | --- | --- |
| `gkos-engine` `2.2.0` | Package version | Current source/candidate identity, not proof of publication. | Matches `ENGINE_VERSION` and `package.json`; frozen historical producer/contract identities remain unchanged. |
