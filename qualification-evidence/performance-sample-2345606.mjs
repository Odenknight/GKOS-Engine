...
const commit='234560673d67047e31ad886b65df62a50f467009';
const expected='da1525e21b6ca8c47fc1a3da583c5252fdf50ee63aae21779a1674e517bf3def';
...
for(const count of [100,2000,10000,50000]){
 ...
 try{
  ...
  row.fixtureDigest=await canonicalSha256(files);
