...
test("Phase 0 fixture locks public exports, Navigation capabilities, and CLI behavior", () => {
  ...
  const graphitiAdditions = ["GRAPHITI_INGEST_SCRIPT", "attachGraphitiSourceEvidence", "GRAPHITI_QUERY_CONTRACT_VERSION", "prepareGraphitiQueryRequest", "acceptGraphitiQueryResult", "managedEpisodeJson", "buildManagedGraphitiManifest", "reconcileManagedGraphitiPublication"].sort();
