...
const linuxFtsTest = process.platform === "linux" && LEXICAL_CAPABILITY.fts5_available ? test : () => {};

linuxFtsTest("Linux shutdown cannot reopen a native watcher after a refresh hook has yielded", async () => {
