# Third-Party Notices and Interoperability Attribution
...
by this engine, not the architectural foundation upon which GKX or this engine
is built. No claim that this project predates or has priority over Google
Cloud's OKF specification is made or implied.
...
Development dependencies retain their respective licenses, including
TypeScript under Apache-2.0 and esbuild under MIT. Exact dependency versions
are recorded in `package.json` and the package lockfile.
